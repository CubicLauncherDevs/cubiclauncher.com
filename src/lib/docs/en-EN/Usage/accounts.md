...
Setting up a user in CubicLauncher is super easy, just follow these steps:

### Step 1
Click on the user section in the sidebar.

<div class="my-4 flex justify-center">
	<img src="/docs/howto/step1.png" alt="Launcher UI" class="rounded-lg border border-neutral-800 max-w-full" />
</div>
