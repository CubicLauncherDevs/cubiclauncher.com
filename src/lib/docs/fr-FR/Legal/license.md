---
title: Licence | CubicLauncher
description: Licences Cubic Launcher
---

# Licence de CubicLauncher
**CubicLauncher** est un projet open source distribué sous la licence [**GNU General Public License v3.0 (GPL-3.0)**](https://www.gnu.org/licenses/gpl-3.0.html).

Vous pouvez trouver le texte complet de la licence dans le fichier [`LICENSE`](https://github.com/CubicLauncher/CubicLauncher/blob/main/LICENSE) à la racine de notre dépôt.
...
Ce projet utilise diverses bibliothèques open source pour son fonctionnement. Ces bibliothèques sont soumises à leurs propres licences, qui incluent :
