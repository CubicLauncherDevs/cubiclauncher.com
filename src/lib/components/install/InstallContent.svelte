<script lang="ts">
  ...
  const platforms = [
    {
      ...
      primaryDownload: "Descargar .exe",
      primaryLink: "#",
      secondaryDownload: "Descargar Portable",
      secondaryLink: "#",
      instructions: [
    ...
    },
    {
      ...
      description:
        "AppImage universal o paquete flatpak para distribuciones Linux.",
  ...
  $: basePlatform = platforms.find((p) => p.id === selectedOS) || platforms[0];
  $: activePlatform = {
    ...basePlatform,
